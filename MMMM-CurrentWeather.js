...
Module.register("MMMM-CurrentWeather",{
	...
	getDom: function() {
		...
		var colorTemperature = 'frozen';

		if (this.temperature >= 35) {
			colorTemperature = 'hell';
		} else if (this.temperature >= 30) {
			colorTemperature = 'hot';
		} else if (this.temperature >= 25) {
			colorTemperature = 'warm';
		} else if (this.temperature >= 20) {
			colorTemperature = 'nice';
		...
		temperature.className = "bright temperature-" + colorTemperature;
